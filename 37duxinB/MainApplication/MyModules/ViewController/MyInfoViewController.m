...
void initData(MyInfoViewController *vc){
    ...
    NSString *nickName = FetchRealName;
    ...
    NSString *aresString = @"";
    if (FetchUserArea) {
        aresString = FetchUserArea;
    }
    
    NSMutableDictionary *dic3 = [[NSMutableDictionary alloc] initWithObjectsAndKeys:@"所在地",@"title",aresString,@"content",nil];
    [vc->_dataArray  addObject:dic0];
    [vc->_dataArray  addObject:dic1];
    [vc->_dataArray  addObject:dic2];
    [vc->_dataArray  addObject:dic3];
...
-(void)showAreaAction{
    ...
    view.fetchAreaBlock = ^(NSString *string) {
        NSMutableDictionary *dic = _dataArray[3];
...
-(void)postPersonalInfo{
    ...
    NSMutableDictionary *dic = [[NSMutableDictionary alloc] init];
    NSString *string = FetchUsername;
    [dic setObject:string forKey:@"username"];
    [dic setObject:[_dataArray[0] objectForKey:@"content"]  forKey:@"avatar"];
    [dic setObject:[_dataArray[1] objectForKey:@"content"] forKey:@"name"];
    if ([[_dataArray[2] objectForKey:@"content"] integerValue] != 0) {
        [dic setObject:[_dataArray[2] objectForKey:@"content"] forKey:@"gender"];
    }
    NSString *areaString = [_dataArray[3] objectForKey:@"content"];
