...
-(void)createUI
{
    ...
    self.scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0,bottom(self.navView),SIZE.width,SIZE.height-bottom(self.navView))];
    self.scrollView.showsVerticalScrollIndicator = YES;
    self.scrollView.showsHorizontalScrollIndicator = NO;
    self.scrollView.scrollEnabled = YES;//控制是否可以滚动
    self.scrollView.userInteractionEnabled = YES;//控制是否可以响应用户点击事件（touch）
