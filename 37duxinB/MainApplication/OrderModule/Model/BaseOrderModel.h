...
@property(nonatomic,copy)NSString *consultantUsername;//被咨询者名称
@property(nonatomic,copy)NSString *consultantUserAvatar;//被咨询者头像
@property(nonatomic,copy)NSString *consultantUserId;//被咨询者ID
