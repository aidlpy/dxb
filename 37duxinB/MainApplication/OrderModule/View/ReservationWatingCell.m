...
@implementation ReservationWatingCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [_btnAction setTitleColor:Color_FF5166 forState:UIControlStateNormal];
        ...
        _contactBtn = [[UIButton alloc] initWithFrame:CGRectMake(SIZE.width-82,bottom(bottomLine)+5, 70, 27)];
        _contactBtn.titleLabel.font = FONT_14;
        [_contactBtn.layer setCornerRadius:2.0f];
        [_contactBtn.layer setBorderColor:Color_DCDCDC.CGColor];
        [_contactBtn.layer setBorderWidth:1.0f];
        [_contactBtn setTitle:@"联系用户" forState:UIControlStateNormal];
        [_contactBtn setTitleColor:Color_1F1F1F forState:UIControlStateNormal];
...
-(void)contactAction{
    ...
    if (_contactCustomerBlock) {
        _contactCustomerBlock(self.tag);
    }
