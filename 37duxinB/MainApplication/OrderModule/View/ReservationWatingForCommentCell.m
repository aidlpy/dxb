//
//  ReservationWatingForCommentCell.m
//  37duxinB
//
...
@implementation ReservationWatingForCommentCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [_btnAction setTitle:@"待评价" forState:UIControlStateNormal];
        [_btnAction setTitleColor:Color_F9A108 forState:UIControlStateNormal];
