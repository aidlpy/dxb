...
@implementation DeepConsultingTypeOneCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(15,h(_oldPriceLabel)/2, w(_oldPriceLabel)/2,1)];
        ...
        _deleteBtn = [[UIButton alloc] initWithFrame:CGRectMake(SIZE.width-82,bottom(_usedPageDeatils)+8, 70, 30)];
        _deleteBtn.titleLabel.font = FONT_14;
        [_deleteBtn.layer setCornerRadius:2.0f];
        [_deleteBtn.layer setBorderColor:Color_DCDCDC.CGColor];
        [_deleteBtn.layer setBorderWidth:1.0f];
        [_deleteBtn setTitle:@"删除订单" forState:UIControlStateNormal];
        [_deleteBtn setTitleColor:Color_1F1F1F forState:UIControlStateNormal];
