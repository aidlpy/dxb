...
typedef void (^contactCustomerBlock)(NSInteger tag);
@interface ReservationWatingCell : UITableViewCell
...
@property(nonatomic,copy)contactCustomerBlock contactCustomerBlock;
