...
@implementation DeepCheckCommentCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _checkCommentBtn = [[UIButton alloc] initWithFrame:CGRectMake(SIZE.width-82,bottom(bottomLine)+5, 70, 27)];
        _checkCommentBtn.titleLabel.font = FONT_14;
        [_checkCommentBtn.layer setCornerRadius:2.0f];
        [_checkCommentBtn.layer setBorderColor:Color_DCDCDC.CGColor];
        [_checkCommentBtn.layer setBorderWidth:1.0f];
        [_checkCommentBtn setTitle:@"查看评价" forState:UIControlStateNormal];
        [_checkCommentBtn setTitleColor:Color_1F1F1F forState:UIControlStateNormal];
