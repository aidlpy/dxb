...
-(void)_sendMessage:(EMMessage *)message isNeedUploadFile:(BOOL)isUploadFile
{
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        [self postMessage:message isNeedUploadFile:isUploadFile];
    });
...
-(void)postMessage:(EMMessage *)message isNeedUploadFile:(BOOL)isUploadFile{
    
    EMMessageBody *msgBody = message.body;
    NSMutableDictionary *dic = [NSMutableDictionary new];
    [dic setObject:message.to forKey:@"messageto"];
    [dic setObject:message.from forKey:@"messageform"];
    NSString *username = FetchUserNickName;
    NSString *myHeaderImageString = FetchUserHeaderImage;
    [dic setObject:username forKey:@"formname"];
    [dic setObject:myHeaderImageString forKey:@"formavatar"];
